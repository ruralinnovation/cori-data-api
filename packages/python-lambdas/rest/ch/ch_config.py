...
CONFIG = {
    ...
    "ch_app_var_xwalk_county": {
        "table": "proj_climate.ch_app_var_xwalk_county",
    ...
    "ch_app_var_xwalk_tract": {
        "table": "proj_climate.ch_app_var_xwalk_tract",
    ...
    "ch_app_wide_county": {
        "table": "proj_climate.ch_app_wide_county",
    ...
    "ch_app_wide_tract": {
        "table": "proj_climate.ch_app_wide_tract",
    ...
    "ch_app_wide_county_geo": {
        "table": "proj_climate.ch_app_wide_county_geo",
    ...
    "ch_app_wide_tract_geo": {
        "table": "proj_climate.ch_app_wide_tract_geo",
