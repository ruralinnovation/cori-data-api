...
ch variable count
"""
@app.get("/<tab>/count", compress=False)
def get_ch_count(tab):

    table = f'ch_app_var_xwalk_{tab}'

    """
    Count available variables in <table> with where clause based on <params>
    """
    print(f'Count available variables in {table} on system:')
    print(os.environ)
...
def get_ch_count(tab):
    ...
    """
    print(f'List available variables in {table} on system:')
    print(os.environ)
...
#         order_by = columns
    ...
    result = {
        'type': 'Variables',
        'variable': [item for sublist in vars for item in sublist]
        }
...
#     """
#     print(f'testing ch endpoint /testing/{table} on system:')
#     print(os.environ)
#
#     logger.info(os.environ)
#
